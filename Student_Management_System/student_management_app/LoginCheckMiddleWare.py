...
class LoginCheckMiddleWare(MiddlewareMixin):
    ...
    def process_view(self,request,view_func,viw_args,view_kwargs):
        ...
        if user.is_authenticated:
            if user.user_type =='1':
                if modulename == 'student_management_app.HodViews':
                    pass
                elif modulename == 'student_management_app.views' or 'django.views.static':
                    pass
                else:
                ...
                if modulename == 'student_management_app.StudentView'  or 'django.views.static':
                    pass
